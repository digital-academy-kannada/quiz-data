...
GlobalFonts.registerFromPath(
  ...
  "Noto Sans"
);                                                                                                                                                      let currentQuiz = null;                                                     let stateUpdatedForQuiz = null;
...
async function loadCurrentQuiz() {
  try {
    const res = await fetch(
      "https://raw.githubusercontent.com/digital-academy-kannada/quiz-data/main/state.json"
    );
...
bot.on(
  ...
  // ===== QUIZ LIST =====
  if (data === "quizlist") {
console.log("Quiz List button clicked");
...
`reject_${chatId}`
  ...
  try {
    ...
    let res = await fetch(
`https://raw.githubusercontent.com/digital-academy-kannada/quiz-data/main/${g.quizCode}.json`
    );
...
(msg) => {
  ...
  try {
    ...
    const res = await fetch(
      `https://raw.githubusercontent.com/digital-academy-kannada/quiz-data/main/${quizCode}.json`
    );
